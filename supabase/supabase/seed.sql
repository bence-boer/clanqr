...
INSERT INTO sessions (id, user_id, token, expires_at) VALUES
    ('00000000-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000000001', 'dev-admin-session-token', '2099-12-31T23:59:59Z'),
    ('00000000-0000-0000-0000-000000000012', '00000000-0000-0000-0000-000000000002', 'dev-session-token', '2099-12-31T23:59:59Z')
ON CONFLICT (id) DO NOTHING;
