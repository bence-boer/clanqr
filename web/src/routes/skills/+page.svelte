...
<div class="page" aria-busy={loading}>
  <div class="page-header">
    ...
    <div class="header-right">
      ...
      {/if}
      <button class="btn-refresh" onclick={handle_refresh} disabled={refreshing}>
        <span class="icon">{refreshing ? 'progress_activity' : 'refresh'}</span>
  ...
  {:else if skills.length === 0}
    <EmptyState
      ...
      detail="Add skill directories to ~/.copilot/skills/"
    />
  {:else}
