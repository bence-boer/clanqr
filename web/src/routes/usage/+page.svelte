...
<div class="page">
  ...
  <RunHistory
    ...
    {filter_status}
    {current_page}
    onfilter_type_change={(value) => { filter_type = value; current_page = 1; }}
    onfilter_status_change={(value) => { filter_status = value; current_page = 1; }}
    onpage_change={(page) => { current_page = page; }}
  />
</div>
